...
from backend.ingredient_identification import identify_ingredients
from backend.recipe_generator import match_recipes
...
def format_recipe(recipe: Dict[str, Any]) -> str:
    ...
    formatted += f"**Cooking Time:** {recipe.get('Cooking Time (mins)', 'N/A')} minutes\n\n"
